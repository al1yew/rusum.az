...
$(document).ready(function () {
  ...
  if ($(document).width() < 576) {
    $(".resultkeeper").hide();
    $(".garantautoadvert").attr(
      "href",
      "https://www.instagram.com/garantauto.az/"
    );
  }
  ...
  $(document).on("submit", "#mainForm", function (e) {
    ...
    selectedDate =
      trimmedarray[2] + "-" + trimmedarray[1] + "-" + trimmedarray[0];
    ...
    if (autoType == "auto") {
      ...
      //190.4.1-4.
      if (
        (today - date) / 1000 / 60 / 60 / 24 / 365 > 7 &&
        (engineType == "benzin" ||
          engineType == "qaz" ||
          engineType == "hibrid-benzin")
      ) {
      ...
      if (volume <= 2000) {
        ...
        var addition = 2;
        aksiz =
          (5600 + (volume - 3000) * (13 + addition * koeffForThreeYears)) *
          koeffForSevenYears;
      } else if (volume > 4000 && volume <= 5000) {
        var addition = 5;
        aksiz =
          (20600 + (volume - 4000) * (35 + addition * koeffForThreeYears)) *
          koeffForSevenYears;
      } else if (volume > 5000) {
        var addition = 10;
        aksiz =
          (60600 + (volume - 5000) * (70 + addition * koeffForThreeYears)) *
          koeffForSevenYears;
      }
      ...
      if (
        (engineType == "hibrid-benzin" || engineType == "hibrid-dizel") &&
